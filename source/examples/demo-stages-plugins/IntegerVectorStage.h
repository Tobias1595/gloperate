...
*/
class IntegerVectorStage : public gloperate::Stage
{
public:
    CPPEXPOSE_DECLARE_COMPONENT(
        IntegerVectorStage, gloperate::Stage
      , "" // Tags
      , "" // Icon
      , "" // Annotations
      , "Stage that collects and provides components from GLM vectors using swizzling"
...
public:
    ...
    *    Stage name
    */
    IntegerVectorStage(gloperate::Environment * environment, const std::string & name = "IntegerVectorStage");

    /**
    *  @brief
    *    Destructor
    */
    virtual ~IntegerVectorStage();
...
protected:
    static const std::map<char,size_t> s_indexByLabel;
